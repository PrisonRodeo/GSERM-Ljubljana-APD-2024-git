...
#
# File last updated January 11, 2024
#
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# OBJECTS                                 #########
#
...
setwd("~/Dropbox (Personal)/GSERM/Ljubljana 2024")
...
# R "package" called "readr" that can handle
# URLs. 
...
SCOTUS <- read_csv("https://github.com/PrisonRodeo/GSERM-Ljubljana-APD-2024-git/raw/main/Data/SCOTUS-votes.csv")
